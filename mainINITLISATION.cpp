...
int main(int argc, char const *argv[])
{
    ...
    Vol volNewYorkParis(8, 05, 2023, 15, 05, 2023, &aeroportDeLondre, &aeroportDeParis, 180, 495.90, 6, 5, &QatarAirways);
   
    // INITLISATION DES AVIONS 

    AvionDeLigne Avion1("Boeing 737", 150, 900, 11000, 350, 5000, 1,1,2023, "France", &AirFrance, &volParisLondre, 20, 100, 30);
    AvionDeLigne Avion2("Boeing 430", 200, 1000, 12000, 400, 7000, 5,4,2022, "France", &Emirates, &volParisLondre, 20, 150, 30);
    AvionDeLigne Avion3("Boeing A380", 853, 900, 13100, 1235, 15200, 25,10,2007, "France", &DeltaAirLines, &volNewYorkParis, 98, 555, 14);
    AvionDeLigne Avion4("Boeing 777", 550, 905, 13100, 239.370, 15843, 7,6,1995, "Etats-Unis", &QatarAirways, &volParisNewYork, 70, 430, 50);
    AvionDeLigne Avion5("Boeing 787", 330, 903, 13100, 118, 15372, 26, 10, 2011, "Etats-Unis", &Lufthansa, &volBerlinParis, 48, 230, 52);
   
    JetPrive Jet1("Gulfstream G650", 19, 956, 15545, 24.5, 12964, 01,01,2012, "Etats-Unis", &DeltaAirLines, &volLondreBerlin, 1,1,1);
    JetPrive Jet2("Bombardier Global 7500", 19, 930, 15545, 24.5, 14264, 01,01,2018, "Canada", &Lufthansa, &volLondreBerlin, 1,2,1);
    JetPrive Jet3("Dassault Falcon 8X", 14, 900, 15545, 19.3, 11945, 01,01,2016, "France", &AirFrance, &volParisLondre ,1,1,2);
    JetPrive Jet4("Dassault Falcon 7X", 16, 1060, 15545, 31, 11000, 01,01,2007, "France", &Emirates, &volNewYorkParis,1,1,1);
    JetPrive Jet5("Embraer Phenom 300", 10, 834, 13716, 9.585, 3650, 01, 01, 2009, "Bresil", &QatarAirways,&volParisNewYork,1, 0, 0);
