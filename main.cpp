...
Vol volLondresBerlin(20, 04, 2023, 20, 04, 2023, &aeroportDeLondres, &aeroportDeBerlin, 120, 198.75, 3, 2, &Lufthansa);
Vol volBerlinParis(24, 04, 2023, 25, 04, 2023, &aeroportDeBerlin, &aeroportDeParis, 160, 305.20, 1, 3, &AirFrance);
Vol volParisNewYork(30, 04, 2023, 01, 05, 2023, &aeroportDeParis, &aeroportDeNewYork, 200, 560.40, 7, 8, &Emirates);
Vol volNewYorkParis(8, 05, 2023, 9, 05, 2023, &aeroportDeNewYork, &aeroportDeParis, 180, 495.90, 6, 5, &DeltaAirLines);
    ...
    do {
        ...
        switch (choice) {
            ...
            case 2:
                ...
                aeroportDeNewYork.displayInfoAeroport();
...
void acheterBillet(int a, Vol& vol) {
    ...
    int count = 1;
        ...
        if ((ticketBooked) or ( count > vol.getNombrePlaces() )){
            ...
            ticketsFileOut << vol.getIdVol() << " " << client.getNumeroClient() << " " << count << " " << "Business" << " " << count << std::endl;
...
void infoCompte(){
    ...
    do {
        ...
        std::cout << "2. Afficher vos billets reserves \n";
        std::cout << "0. Quitter \n";
        std::cout << "--------------------------------------------------\n";
